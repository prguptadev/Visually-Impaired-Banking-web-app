...
<center><h1> RESET PASSWORD </h1></center>
	...
	<div class="w3-container" style="background: none;">
		...
		<div class="col-lg-6 m-auto d-block"  style="background: none;" >
			...
			<form action="Fopass" onsubmit="return validation()" style="background: none;">
				
				<div class="form-group">
				
					<label for="user" class="font-weight-bold" style="transform: translate(0px,150px)"><h2>New Password</h2> </label>&nbsp;&nbsp;  <span id="username"  class="text-danger font-weight-bold"> </span>
					<input type="password" name="fupass" class="form-control" style="height: 65px;width: 600px;transform: translate(-10px,160px);font-size: 20px;font-weight: 700;" id="user" onkeyup ="speak(this)"  onfocus="myFunction(this)" 
