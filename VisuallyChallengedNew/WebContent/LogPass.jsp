...
function loginn(){
	responsiveVoice.speak(" Please set your password");
	}
...
function log1(){
	...
	function log2(){
	responsiveVoice.speak("Click to go back to the username Page");
	}
	function log3(){
...
<center><h1>CREATE PASSWORD</h1></center>
	...
	<div class="w3-container" style="background: none;">
		...
		<div class="col-lg-6 m-auto d-block"  style="background: none;" >
			...
			<form action="Log2" onsubmit="return validation()" style="background: none;" method="POST">
				...
				<div class="form-group">
					...
					<input type="password" name="userps" class="form-control" style="height: 65px;width: 600px;transform: translate(-10px,160px);font-size: 20px;font-weight: 700;" id="user" onkeyup ="speak(this)"  onfocus="myFunction(this)" 
