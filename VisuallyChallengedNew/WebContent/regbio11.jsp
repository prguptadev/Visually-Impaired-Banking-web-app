...
<body style=" background-image: url('resources/image/background6.jpg');
    ...
    onload="loginn()">
	<hr>
<form action ="regbio11">
	<h1 class = "h1">REGISTRATION DETAILS</h1>
	<hr>
	<br>
	<div  id = "demo" class = "h1">
		...
		<br>
		  <input type="submit" class="w3-btn w3-block w3-pink w3-border w3-xxlarge" id="btnCapture" value="Capture" class="button2" onclick="return Capture()" name ="efbio" />
